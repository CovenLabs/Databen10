...
cormpg_cyl
corrplot(cordata)
#changes the corrplot to different visualization format
...
titanic
View(titanic)
#shows the sum of not availabe data
sum(is.na(titanic))
...
cleanednew$age[is.na(cleanednew$age)]<-mean(cleanednew$age,na.rm= T)
set.seed(1234)
#Splitting into train and test set.
mydata<-read.csv("C:/Users/mziyarnu/Documents/R training/Data science/TITANY.csv")
titrain<-sample(2,nrow(titann),prob=c(0.60,0.40), replace=TRUE)
